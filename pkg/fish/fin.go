...
func (f Fin) GetPossibleParentsFins() set.Set[FinParent] {
	...
	case peachy:
		...
		break
	case pink:
		parents.Add(FinParent{Parent1: pink, Parent2: pink})
		parents.Add(FinParent{Parent1: bluetip, Parent2: daffodil})
		parents.Add(FinParent{Parent1: canary, Parent2: crimson})
		parents.Add(FinParent{Parent1: canary, Parent2: tangerine})
		parents.Add(FinParent{Parent1: crimson, Parent2: oriental})
		parents.Add(FinParent{Parent1: daffodil, Parent2: greenfin})
		parents.Add(FinParent{Parent1: imperial, Parent2: spined})
		parents.Add(FinParent{Parent1: orange, Parent2: serrated})
		parents.Add(FinParent{Parent1: orange, Parent2: snubbed})
		parents.Add(FinParent{Parent1: oriental, Parent2: sapphire})
		parents.Add(FinParent{Parent1: peachy, Parent2: spined})
		parents.Add(FinParent{Parent1: pink, Parent2: striped})
		parents.Add(FinParent{Parent1: razorback, Parent2: rusty})
		parents.Add(FinParent{Parent1: razorback, Parent2: tangerine})
		parents.Add(FinParent{Parent1: royal, Parent2: sapphire})
		parents.Add(FinParent{Parent1: royal, Parent2: striped})
		parents.Add(FinParent{Parent1: rusty, Parent2: snubbed})
		break
	case razorback:
		parents.Add(FinParent{Parent1: razorback, Parent2: razorback})
		parents.Add(FinParent{Parent1: canary, Parent2: razorback})
		parents.Add(FinParent{Parent1: canary, Parent2: snubbed})
		parents.Add(FinParent{Parent1: crimson, Parent2: hooked})
		parents.Add(FinParent{Parent1: crimson, Parent2: silky})
		parents.Add(FinParent{Parent1: daffodil, Parent2: pink})
		parents.Add(FinParent{Parent1: daffodil, Parent2: royal})
		parents.Add(FinParent{Parent1: hooked, Parent2: sapphire})
		parents.Add(FinParent{Parent1: imperial, Parent2: pink})
		parents.Add(FinParent{Parent1: imperial, Parent2: striped})
		parents.Add(FinParent{Parent1: oriental, Parent2: serrated})
		parents.Add(FinParent{Parent1: oriental, Parent2: snubbed})
		parents.Add(FinParent{Parent1: peachy, Parent2: sapphire})
		parents.Add(FinParent{Parent1: peachy, Parent2: striped})
		parents.Add(FinParent{Parent1: royal, Parent2: serrated})
		parents.Add(FinParent{Parent1: silky, Parent2: tangerine})
		break
	case royal:
		parents.Add(FinParent{Parent1: royal, Parent2: royal})
		parents.Add(FinParent{Parent1: bluetip, Parent2: hooked})
		parents.Add(FinParent{Parent1: bluetip, Parent2: peachy})
		parents.Add(FinParent{Parent1: canary, Parent2: sapphire})
		parents.Add(FinParent{Parent1: canary, Parent2: striped})
		parents.Add(FinParent{Parent1: crimson, Parent2: razorback})
		parents.Add(FinParent{Parent1: crimson, Parent2: snubbed})
		parents.Add(FinParent{Parent1: daffodil, Parent2: orange})
		parents.Add(FinParent{Parent1: daffodil, Parent2: rusty})
		parents.Add(FinParent{Parent1: greenfin, Parent2: imperial})
		parents.Add(FinParent{Parent1: greenfin, Parent2: peachy})
		parents.Add(FinParent{Parent1: hooked, Parent2: spined})
		parents.Add(FinParent{Parent1: imperial, Parent2: orange})
		parents.Add(FinParent{Parent1: oriental, Parent2: pink})
		parents.Add(FinParent{Parent1: oriental, Parent2: striped})
		parents.Add(FinParent{Parent1: pink, Parent2: royal})
		parents.Add(FinParent{Parent1: razorback, Parent2: sapphire})
		parents.Add(FinParent{Parent1: rusty, Parent2: serrated})
		parents.Add(FinParent{Parent1: serrated, Parent2: tangerine})
		parents.Add(FinParent{Parent1: silky, Parent2: spined})
		parents.Add(FinParent{Parent1: snubbed, Parent2: tangerine})
		break
	case rusty:
		...
		break
	case sapphire:
		parents.Add(FinParent{Parent1: sapphire, Parent2: sapphire})
		parents.Add(FinParent{Parent1: bluetip, Parent2: canary})
		parents.Add(FinParent{Parent1: bluetip, Parent2: razorback})
		parents.Add(FinParent{Parent1: canary, Parent2: greenfin})
		parents.Add(FinParent{Parent1: crimson, Parent2: sapphire})
		parents.Add(FinParent{Parent1: crimson, Parent2: striped})
		parents.Add(FinParent{Parent1: greenfin, Parent2: oriental})
		parents.Add(FinParent{Parent1: orange, Parent2: oriental})
		parents.Add(FinParent{Parent1: orange, Parent2: royal})
		parents.Add(FinParent{Parent1: pink, Parent2: rusty})
		parents.Add(FinParent{Parent1: pink, Parent2: tangerine})
		parents.Add(FinParent{Parent1: razorback, Parent2: spined})
		parents.Add(FinParent{Parent1: royal, Parent2: rusty})
		parents.Add(FinParent{Parent1: snubbed, Parent2: spined})
		parents.Add(FinParent{Parent1: striped, Parent2: tangerine})
		break
	case serrated:
		parents.Add(FinParent{Parent1: serrated, Parent2: serrated})
		parents.Add(FinParent{Parent1: canary, Parent2: imperial})
		parents.Add(FinParent{Parent1: canary, Parent2: peachy})
		parents.Add(FinParent{Parent1: daffodil, Parent2: razorback})
		parents.Add(FinParent{Parent1: daffodil, Parent2: snubbed})
		parents.Add(FinParent{Parent1: hooked, Parent2: oriental})
		parents.Add(FinParent{Parent1: hooked, Parent2: royal})
		parents.Add(FinParent{Parent1: imperial, Parent2: razorback})
		parents.Add(FinParent{Parent1: oriental, Parent2: peachy})
		parents.Add(FinParent{Parent1: pink, Parent2: silky})
		parents.Add(FinParent{Parent1: royal, Parent2: silky})
		parents.Add(FinParent{Parent1: serrated, Parent2: snubbed})
		break
	case silky:
		...
		break
	case snubbed:
		parents.Add(FinParent{Parent1: snubbed, Parent2: snubbed})
		parents.Add(FinParent{Parent1: canary, Parent2: daffodil})
		parents.Add(FinParent{Parent1: canary, Parent2: serrated})
		parents.Add(FinParent{Parent1: daffodil, Parent2: oriental})
		parents.Add(FinParent{Parent1: hooked, Parent2: pink})
		parents.Add(FinParent{Parent1: hooked, Parent2: striped})
		parents.Add(FinParent{Parent1: imperial, Parent2: oriental})
		parents.Add(FinParent{Parent1: imperial, Parent2: royal})
		parents.Add(FinParent{Parent1: peachy, Parent2: pink})
		parents.Add(FinParent{Parent1: peachy, Parent2: royal})
		parents.Add(FinParent{Parent1: razorback, Parent2: serrated})
		parents.Add(FinParent{Parent1: razorback, Parent2: snubbed})
		parents.Add(FinParent{Parent1: sapphire, Parent2: silky})
		parents.Add(FinParent{Parent1: silky, Parent2: striped})
		break
	case spined:
		parents.Add(FinParent{Parent1: spined, Parent2: spined})
		break
	case striped:
		parents.Add(FinParent{Parent1: striped, Parent2: striped})
		parents.Add(FinParent{Parent1: bluetip, Parent2: imperial})
		parents.Add(FinParent{Parent1: bluetip, Parent2: serrated})
		parents.Add(FinParent{Parent1: bluetip, Parent2: snubbed})
		parents.Add(FinParent{Parent1: canary, Parent2: orange})
		parents.Add(FinParent{Parent1: canary, Parent2: rusty})
		parents.Add(FinParent{Parent1: crimson, Parent2: pink})
		parents.Add(FinParent{Parent1: crimson, Parent2: royal})
		parents.Add(FinParent{Parent1: daffodil, Parent2: spined})
		parents.Add(FinParent{Parent1: greenfin, Parent2: razorback})
		parents.Add(FinParent{Parent1: greenfin, Parent2: serrated})
		parents.Add(FinParent{Parent1: greenfin, Parent2: snubbed})
		parents.Add(FinParent{Parent1: orange, Parent2: razorback})
		parents.Add(FinParent{Parent1: oriental, Parent2: rusty})
		parents.Add(FinParent{Parent1: oriental, Parent2: tangerine})
		parents.Add(FinParent{Parent1: pink, Parent2: sapphire})
		parents.Add(FinParent{Parent1: royal, Parent2: tangerine})
		parents.Add(FinParent{Parent1: sapphire, Parent2: striped})
		parents.Add(FinParent{Parent1: serrated, Parent2: spined})
		break
	case tangerine:
